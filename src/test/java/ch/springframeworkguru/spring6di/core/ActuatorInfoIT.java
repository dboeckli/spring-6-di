package ch.springframeworkguru.spring6di.core;
...
class ActuatorInfoIT {
    ...
    void actuatorInfoTest() throws Exception {
        MvcResult result = mockMvc.perform(get("/actuator/info"))
            ...
            .andExpect(jsonPath("$.build.artifact").value("spring-6-di"))
            .andExpect(jsonPath("$.build.group").value("ch.dboeckli.springframeworkguru.spring-6-di"))
            .andReturn();
